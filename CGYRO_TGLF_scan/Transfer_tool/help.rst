...
* 慢化快离子（热化处理）：以电荷和质量识别同种粒子。对应热杂质时将快离子密度并入该热离子；对应所选主离子时保留为独立粒子，其密度不合并，温度、环向流速与极向流速改用“温度 / 流速来源”中所选热杂质的值。需要合并时若缺少同种热离子，或需要独立热化时缺少参考热杂质，均停止；不计算真实慢化分布。
...
“温度 / 流速来源”仅用于对应主离子、独立保留的快离子，候选为
电荷高于所选主离子的热离子。默认取原剖面中的首个热杂质；存在多个
